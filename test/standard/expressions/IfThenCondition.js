...
import IfThenCondition             from '../../../src/standard/expressions/IfThenCondition';
...
describe('standard/expressions/IfThenCondition', function() {
	...
	test('Executes the truthy branch', function() {
		let ifThenProcessor = IfThenCondition.match(new InputBuffer("${condition} ? 'Hello!'"), parser);
